...
def affine_norm_relu_forward(x, w, b,gamma,beta,bn_param):
  ...
  """
  a, fc_cache = affine_forward(x, w, b)
  ynorm, norm_cache = batchnorm_forward(a, gamma, beta, bn_param)
  out, relu_cache = relu_forward(ynorm)
...
def affine_norm_relu_backward(dout, cache):
    ...
    dynorm = relu_backward(dout, relu_cache)
    da, dgamma, dbeta = batchnorm_backward_alt(dynorm, norm_cache)
    dx, dw, db = affine_backward(da, fc_cache)
