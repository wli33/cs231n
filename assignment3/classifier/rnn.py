...
class CaptioningRNN(object):
    ...
    def sample(self, features, max_length=30):
        ...
        for i in range(max_length-1):
            x,_ = word_embedding_forward(captions[:, i], W_embed) #(n,W)
            if self.cell_type == 'rnn':
            ...
            # run step return h with (n,d) affine need(n,t,d) t = 1
            #return (n,t,m) squeeze to (n,m)
...
##            if self.cell_type == 'rnn':
##                h, cache = rnn_step_forward(word_vectors, h, Wx, Wh, b) # n,h
##            
##            scores = h.dot(W_vocab) + b_vocab                 # [N, V] W_vocab:h,v
