...
##print 'db error: ', rel_error(db_num, db)
##
##test the loss function of softmax and svm
##
...
#Sanity check, make sure you can overfit a small dataset of 50 images with 3 layers.
...
##weight_scale = 2e-2
##learning_rate = 1e-3 
##model = FullyConnectedNet([75, 50, 25],
##              weight_scale=weight_scale)
##solver = Solver(model, data,
##                print_every=100, num_epochs=5, batch_size=50,
##                update_rule='rmsprop',
##                optim_config={
##                  'learning_rate': learning_rate,
##                }
